...
The matrices are squares but can be any size. The user can use a variety of different command line arguments as specified by the table below. The user can create random matrices with specified sizes or specific matrices from a given text file.
...
Number of arguments - Argument - Details
...
2	r [number]
	Creates a random matrix with dimensions specified by [number] and outputs every move
